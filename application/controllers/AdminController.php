...
class AdminController extends My_Controller {
    ...
    //scaffolder Asdfasdf start
    public function asdfasdfsAction(){
    	$this->view->model = "Asdfasdf";
    	$this->view->primary = Jien::model($this->view->model)->getPrimary();
    	$this->view->data = Jien::model($this->view->model)->orderBy("asdfasdf.asdfasdf_id DESC")->withPager($this->params('page', 1))->filter($this->params())->get();
    }

    public function asdfasdfAction(){
    	$this->view->model = "Asdfasdf";
    	$id = $this->params('id');
    	if($id){
    		$this->view->data = Jien::model($this->view->model)->get($id);
