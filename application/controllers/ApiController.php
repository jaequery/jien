...
class ApiController extends My_Controller {
    ...
    public function sendAuthSmsAction(){
        ...
        Jien::debug("http://api.tropo.com/1.0/sessions?action=create&token=22d1373864305940bfc4669971bb510878839bd228eb91f0748235e4e435fd25e82414177af71b702c593130&numberToDial={$authenticator_data['authenticator_sms']}&name={$username}&auth_code={$auth_code}");exit;

        $client = new Zend_Http_Client("http://api.tropo.com/1.0/sessions?action=create&token=22d1373864305940bfc4669971bb510878839bd228eb91f0748235e4e435fd25e82414177af71b702c593130&numberToDial={$authenticator_data['authenticator_sms']}&name={$username}&auth_code={$auth_code}");
