...
class GoogleAuthenticator {
    ...
    public function getUrl($user, $hostname, $secret) {
        ...
        $encoder = "http://chart.apis.google.com/chart?chs=200x200&chld=M|0&cht=qr&format=png&chl=";
        $encoderURL = "{$encoder}otpauth://totp/{$user}@{$hostname}%3Fsecret%3D{$secret}";
        //$encoderURL = "otpauth://totp/{$user}@{$hostname}%3Fsecret%3D{$secret}";
        return $encoderURL;
    }
