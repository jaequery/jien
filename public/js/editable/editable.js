        ...
        if(res.status.code == 200){
            ...
            $(document).on('click', '.trig_editable_edit', function(){
                ...
                switch(type){
                    ...
                    case "text":
                        var content = el.html();
                        var html = "<textarea class='' id='editable_content'>"+content+"</textarea>";
                    ...
                    case "wysiwyg":
                        var content = el.html();
                        var html = "<textarea class='wysiwyg' id='editable_content'>"+content+"</textarea>";
                        html += "<button class='trig_editable_save btn btn-large btn-success' data-editable='"+name+"' data-editable-type='"+type+"'>Save</button>";
                        //html += "&nbsp;<button class='trig_editable_reset btn btn-large btn-warning' data-editable='"+name+"' data-editable-type='"+type+"'>Reset</button>";
                        $.colorbox({html:html, width: '70%', height: '70%', scrolling: true, onComplete: function(){
                            $('.wysiwyg').summernote({
